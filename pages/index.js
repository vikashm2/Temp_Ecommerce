        ...
        <div className="glass-card p-12 text-center rounded-3xl relative overflow-hidden">
          ...
          <div className="flex max-w-md mx-auto">
            <input 
              ...
              className="flex-grow glass rounded-l-xl py-3 px-6 focus:outline-none focus:ring-1 focus:ring-purple-500"
            />
            <button className="bg-white text-black font-bold px-8 rounded-r-xl hover:bg-gray-200 transition-colors">Join</button>
          </div>
        </div>
      </section>
    </Layout>
